...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		...
		// 构成主义重构：全站配色已固定为构成主义色板，此值仅作为少数残留组件的保底色相（42=金色）
		hue: 42,
		// 是否对访问者隐藏主题色选择器
		fixed: false,
		// 默认模式："light" 亮色，"dark" 暗色，"system" 跟随系统
		defaultMode: "system", // default to system theme
	},
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/winered_logo.png",
			alt: "Logo",
		},
		// 导航栏标题
		title: "WineRed",
